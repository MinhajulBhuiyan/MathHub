...
namespace trigonometry
{
    ...
    public:
        ...
        // Calculate arcsine (inverse sine) using normal numbers (not degrees)
        ...
        // Calculate arccosine (inverse cosine) using normal numbers (not degrees)
        double acosNormal(double value)
        {
            if (value < -1.0 || value > 1.0) {
                cerr << "Error: acos(" << value << ") is undefined (out of range)." << endl;
                return NAN; // Return NaN for undefined values
            }
        ...
        // Calculate arctangent (inverse tangent) using normal numbers (not degrees)
